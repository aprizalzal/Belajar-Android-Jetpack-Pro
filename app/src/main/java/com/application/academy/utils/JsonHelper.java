package com.application.academy.utils;
...
public class JsonHelper {
    ...
    @SuppressWarnings("ResoltOfMethodCallIgnored")
    /*
    Repository
    Konsep Repository di modul ini masih sederhana, karena hanya menggunakan simulasi API saja.
    */
    ...
    /*
    Dengan menggunakan kode di atas, Anda bisa mengubah file JSON menjadi String.
    ...
    Contohnya untuk mendapatkan semua data Course:
    */
    ...
    Dengan begitu Anda bisa langsung memanggil loadCourse di AcademyRepository.
    */
